...
crop_info = {
    "rice": {
        ...
        "Pests": "Rice stem borers, Brown planthoppers, Rice leafhoppers",
    ...
    "maize": {
        ...
        "Pests": "Maize stalk borers, Fall armyworm",
        "Diseases": "Maize lethal necrosis, Gray leaf spot, Common rust",
    ...
    "kidneybeans": {
        ...
        "Pests": "Bean fly, Aphids",
        "Diseases": "Angular leaf spot, Bean common mosaic virus",
        "Weed Management": "Manual weeding",
    ...
    "pigeonpeas": {
        ...
        "Pests": "Pod borers, Pod fly",
        "Diseases": "Fusarium wilt, Phytophthora blight",
        "Weed Management": "Manual weeding",
    ...
    "mungbean": {
        ...
        "Spacing": "30-45 cm between plants",
        "Pests": "Aphids, Thrips",
        "Diseases": "Yellow mosaic virus, Powdery mildew",
        "Weed Management": "Manual weeding",
    ...
    "banana": {
        ...
        "Diseases": "Panama disease (Fusarium wilt), Black Sigatoka, Banana bunchy top virus (BBTV)",
    ...
    "mango": {
        ...
        "Pests": "Mango weevil, Fruit flies, Aphids",
    ...
    "grapes": {
        ...
        "Pests": "Mealybugs, Grape berry moth, Spider mites",
    ...
    "watermelon": {
        ...
        "Pests": "Melon aphid, Fruit flies, Spider mites",
        "Diseases": "Fusarium wilt, Powdery mildew, Anthracnose",
        "Weed Management": "Regular weeding and mulching",
    ...
    "muskmelon": {
        ...
        "Sunlight": "Requires full sunlight, 8-10 hours per day",
        "Spacing": "1-2 meters between plants",
        "Pests": "Melon aphid, Leaf miners, Whiteflies",
    ...
    "orange": {
        ...
        "Pests": "Citrus leaf miner, Aphids, Citrus psyllid",
        "Diseases": "Citrus canker, Greening disease (Huanglongbing), Black spot",
        "Weed Management": "Regular weeding and mulching",
    ...
    "papaya": {
        ...
        "Sunlight": "Requires full sunlight, 8-10 hours per day",
        "Spacing": "2-3 meters between plants",
        "Pests": "Papaya mealybug, Aphids, Fruit flies",
        "Diseases": "Papaya ringspot virus (PRSV), Anthracnose, Powdery mildew",
        "Weed Management": "Regular weeding or mulching",
        "Harvesting Time": "9-12 months after planting",
    },
    "coconut": {
        ...
        "Sunlight": "Requires full sunlight, 8-10 hours per day",
        "Spacing": "8-10 meters between plants",
        "Pests": "Rhinoceros beetle, Coconut mite, Red palm weevil",
        "Diseases": "Lethal yellowing, Bud rot, Root (wilt) disease",
        "Weed Management": "Regular weeding and mulching",
    ...
    "cotton": {
        ...
        "Diseases": "Cotton wilt, Bacterial blight, Boll rot",
    ...
    "jute": {
        ...
        "Pests": "Jute weevil, Stem borer, Aphids",
        "Diseases": "Stem rot, Black band disease, Anthracnose",
    ...
    "coffee": {
        ...
        "Spacing": "2-3 meters between plants",
        "Pests": "Coffee berry borer, Coffee leaf miner, Antestia bug",
        "Diseases": "Coffee leaf rust, Coffee berry disease (CBD), Root rot",
        "Weed Management": "Regular weeding or mulching",
        "Harvesting Time": "3-4 years after planting for mature trees",
    },
}
